            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav mx-auto">
                        ...
                        <li className="nav-item px-lg-4"><a className="nav-link text-uppercase" onClick={{}}>About</a></li>
                        <li className="nav-item px-lg-4"><a className="nav-link text-uppercase" onClick={{}}>Products</a></li>
                        <li className="nav-item px-lg-4"><a className="nav-link text-uppercase" onClick={{}}>Store</a></li>
                    </ul>
                </div>
            </div>
        </nav>
